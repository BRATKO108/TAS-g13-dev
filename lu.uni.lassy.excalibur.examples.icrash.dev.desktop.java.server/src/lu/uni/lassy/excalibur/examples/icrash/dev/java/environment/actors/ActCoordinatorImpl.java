...
public class ActCoordinatorImpl extends ActAuthenticatedImpl implements ActCoordinator {
	 ...
	 * @see lu.uni.lassy.excalibur.examples.icrash.dev.java.environment.actors.ActCoordinator#oeSetCrisisHandler(lu.uni.lassy.excalibur.examples.icrash.dev.java.system.types.primary.DtCrisisID)
	 */
	synchronized public PtBoolean oeSetCrisisTime(DtCrisisID aDtCrisisID, String time) throws RemoteException, NotBoundException {
		...
		log.info("message ActCoordinator.oeSetCrisisTime sent to system");
		PtBoolean res = iCrashSys_Server.oeSetCrisisTime(aDtCrisisID, time);
			
			
		if(res.getValue() == true)
			log.info("operation oeSetCrisisTime successfully executed by the system");
