...
public interface ActProxyCoordinator extends ActProxyAuthenticated {
	...
	/**
	 * Sets the crisis' Time, with the ID passed, as the current user.
	 *
	 * @param aDtCrisisID The ID of the crisis to change the handler of
	 * @return The success of the method
	 * @throws RemoteException Thrown if the server is offline
	 * @throws NotBoundException Thrown if the server has not been bound correctly in RMI settings
	 */
	public PtBoolean oeSetCrisisTime(DtCrisisID aDtCrisisID, String time) throws RemoteException, NotBoundException;
