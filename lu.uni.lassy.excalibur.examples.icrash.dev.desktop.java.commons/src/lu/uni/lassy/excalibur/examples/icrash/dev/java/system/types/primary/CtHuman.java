...
public class CtHuman implements Serializable {
	...
	/**
	 * used to specify the property of having sent an Time to react
	 *
	 * @return the success of the method
	 * @throws RemoteException Thrown if the server is offline
	 */
	public PtBoolean isTime(String time) throws RemoteException {
		...
		try{
			...
			if(theComCompany != null){
				DtSMS sms = new DtSMS(new PtString("Help is go to "+time+" minutes"));
			...
			log.error("Exception in CtHuman.isTime ..." + ex);
		}
